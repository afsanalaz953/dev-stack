...
<div className="grid sm:grid-cols-6 lg:grid-cols-12 gap-6 p-6 sm:gap-6 sm:py-4">
    {/* Left side: all cards grid */}
    <div className="allcards grid sm:grid-cols-1 lg:grid-cols-3 col-span-9 gap-2 space-y-10 p-10 ">
      {data.map((newProduct) => (
